...
----- (required args) -----
python3 scripts/generate_ret_experience.py 3 /path/to/retrieval_evaluation/results "['PORTULAN/serafim-100m-portuguese-pt-sentence-encoder-ir']" --batch_size 32
