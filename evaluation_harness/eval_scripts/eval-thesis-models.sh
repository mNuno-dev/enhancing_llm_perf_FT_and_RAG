#! /usr/bin/bash
# Evaluation script used for the thesis fine-tuned model variants.
# Supports vLLM-based models and local completions servers (see the NOTE below).
...
# Thesis fine-tuned models
# NOTE: Paths below are environment-specific. Replace with the local path to your merged model directory.
# Example: model_paths+=" $(readlink -f /path/to/your/model)"
...
# model_paths+=" $(readlink -f /home/nmarques/thesisModels/gervasio-3b-302/gervasio-3b-302-alpha64-merged)"
# model_paths+=" $(readlink -f /home/nmarques/thesisModels/gervasio-3b-302/gervasio-3b-302-alpha128-merged)"
# model_paths+=" $(readlink -f /home/nmarques/thesisModels/gervasio-3b-303/gervasio-3b-303-alpha64-merged)"
# model_paths+=" $(readlink -f /home/nmarques/thesisModels/gervasio-3b-303/gervasio-3b-303-alpha128-merged)"
# model_paths+=" $(readlink -f /home/nmarques/thesisModels/gervasio-3b-304/gervasio-3b-304-alpha64-merged)"
# model_paths+=" $(readlink -f /home/nmarques/thesisModels/gervasio-3b-304/gervasio-3b-304-alpha128-merged)"
    ...
    for model_path in $model_paths; do
        ...
        for task in $tasks; do
            ...
            case $model_path in
                ...
                /home/nmarques/thesisModels/gervasio-3b-*/gervasio-3b-*-*-merged)
