...
async def main():
    ...
    # Each entry is a directory containing JSONL files for one retrieval configuration.
    # Path format: /path/to/your/generation_results/<model>/<retrieval_config>/<emb_model>/<top_k>
    # Example entries:
    #   "/path/to/your/generation_results/Llama8B/fin_hnsw_PTwikiRAG_meanPooling_hybrid0.4/Qwen/Qwen3-Embedding-8B/top1",
    #   "/path/to/your/generation_results/Gervasio3B/fin_hnsw_PTwikiRAG-Pro_meanPooling_hybrid0.3/Qwen/Qwen3-Embedding-8B/top5",
    p_list = []
