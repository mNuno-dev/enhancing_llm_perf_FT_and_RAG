...
class CorrectnessClassifier(
    ...
    instruction = "Dada uma ground truth e um conjunto de afirmações da resposta, analisa cada afirmação e classifica-a numa das seguintes categorias:\n- TP (true positive): afirmações presentes na resposta que são também diretamente suportadas por uma ou mais afirmações na ground truth;\n- FP (false positive): afirmações presentes na resposta mas não diretamente suportadas por nenhuma afirmação na ground truth;\n- FN (false negative): afirmações presentes na ground truth mas ausentes na resposta.\n\nCada afirmação só pode pertencer a uma única categoria.\nFornece uma justificação para cada classificação."
    ...
    examples = [
        (
            QuestionAnswerGroundTruth(
                question="O que alimenta o Sol e qual é a sua função principal?",
                answer=[
                    "O Sol é alimentado por fissão nuclear, semelhante aos reatores nucleares na Terra.",
                    "A função principal do Sol é fornecer luz ao sistema solar.",
                ],
                ground_truth=[
                    "O Sol é alimentado por fusão nuclear, em que átomos de hidrogénio se fundem para formar hélio.",
                    "Este processo de fusão no núcleo do Sol liberta uma enorme quantidade de energia.",
                    "A energia do Sol fornece calor e luz, essenciais para a vida na Terra.",
                    "A luz do Sol desempenha um papel crítico no sistema climático da Terra.",
                    "A luz solar ajuda a impulsionar o tempo meteorológico e as correntes oceânicas.",
                ],
            ),
            ClassificationWithReason(
                TP=[
                    StatementsWithReason(
                        statement="A função principal do Sol é fornecer luz ao sistema solar.",
                        reason=(
                            "A ideia de o Sol fornecer luz é suportada pela ground truth, "
                            "que refere que a energia do Sol fornece luz e descreve o papel da luz solar."
                        ),
                    )
                ],
                FP=[
                    StatementsWithReason(
                        statement="O Sol é alimentado por fissão nuclear, semelhante aos reatores nucleares na Terra.",
                        reason=(
                            "Isto contradiz a ground truth, que indica que o Sol é alimentado por fusão nuclear, "
                            "não por fissão."
                        ),
                    )
                ],
                FN=[
                    StatementsWithReason(
                        statement="O Sol é alimentado por fusão nuclear, em que átomos de hidrogénio se fundem para formar hélio.",
                        reason=(
                            "Esta descrição correta da fonte de energia do Sol não está incluída na resposta."
                        ),
                    ),
                    StatementsWithReason(
                        statement="Este processo de fusão no núcleo do Sol liberta uma enorme quantidade de energia.",
                        reason="O processo de fusão e a libertação de energia não são mencionados na resposta.",
                    ),
                    StatementsWithReason(
                        statement="A energia do Sol fornece calor e luz, essenciais para a vida na Terra.",
                        reason=(
                            "A resposta menciona apenas luz e omite o calor e a sua relevância para a vida, "
                            "que a ground truth inclui."
                        ),
                    ),
                    StatementsWithReason(
                        statement="A luz do Sol desempenha um papel crítico no sistema climático da Terra.",
                        reason="O impacto da luz do Sol no sistema climático da Terra não é abordado na resposta.",
                    ),
                    StatementsWithReason(
                        statement="A luz solar ajuda a impulsionar o tempo meteorológico e as correntes oceânicas.",
                        reason="O efeito da luz solar no tempo meteorológico e nas correntes oceânicas é omitido na resposta.",
                    ),
                ],
            ),
        ),
        (
            QuestionAnswerGroundTruth(
                ...
                answer=["O ponto de ebulição da água é 100 graus Celsius ao nível do mar."],
                ground_truth=[
                    "O ponto de ebulição da água é 100 graus Celsius (212 graus Fahrenheit) ao nível do mar.",
                    "O ponto de ebulição da água pode variar com a altitude.",
                ],
            ),
            ClassificationWithReason(
                TP=[
                    StatementsWithReason(
                        statement="O ponto de ebulição da água é 100 graus Celsius ao nível do mar.",
                        reason=(
                            "Isto é diretamente suportado pela ground truth, que especifica 100°C ao nível do mar."
                        ),
                    )
                ],
                FP=[],
                FN=[
                    StatementsWithReason(
                        statement="O ponto de ebulição da água pode variar com a altitude.",
                        reason=(
                            "Esta informação adicional presente na ground truth não é mencionada na resposta."
                        ),
                    )
                ],
            ),
...
@dataclass
class AnswerCorrectness_PT(MetricWithLLM, MetricWithEmbeddings, SingleTurnMetric):
    """
...
answer_correctness_pt = AnswerCorrectness_PT()
