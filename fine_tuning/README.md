...
`gervasio` is a Python package for LoRA fine-tuning and FSDP distributed training of large language models, with support for checkpoint management, instruction packing, and adapter merging. It was used to fine-tune the Gervásio model family (1B, 3B, 8B) on the PTwikiRAG retrieval corpus.
